...
icacls %SUBDIR%ExportData /deny UCOM\ServiceAcct:(OI)(CI)F /T
icacls %SUBDIR%ImportData /deny UCOM\ServiceAcct:(OI)(CI)F /T

REM grant access to Import/ExportData for FileOps 
icacls %SUBDIR%ExportData /grant UCOM\FileOps:(OI)(CI)F /T
icacls %SUBDIR%ImportData /grant UCOM\FileOps:(OI)(CI)F /T
